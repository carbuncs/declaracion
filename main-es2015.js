...
let TodoService = class TodoService {
    ...
    getTodos() {
        return this.db.collection(this.todoCollectionName, ref => ref.orderBy('lastModifiedDate', 'desc')).get();
    }
    saveTodo(todo) {
...
let TodoFormComponent = class TodoFormComponent {
    constructor(formBuilder, activeModal, todoService) {
    ...
    handleSuccessfulSaveTodo(response, todo) {
...
let TodoListComponent = class TodoListComponent {
    constructor(modalService, todoService) {
    ...
    clickAddTodo() {
        const modal = this.modalService.open(_todo_form_todo_form_component__WEBPACK_IMPORTED_MODULE_3__["TodoFormComponent"]);
    ...
    handleDeleteClick(todoId, index) {
