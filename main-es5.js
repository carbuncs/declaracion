(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            "use strict";
            __webpack_require__.r(__webpack_exports__);
            /* harmony default export */ __webpack_exports__["default"] = ("<div class=\"modal-header\">\n  <h4 class=\"modal-title\">{{createMode ? '¿Qué sucedio?' : 'Edit Todo'}}</h4>\n  <button type=\"button\" class=\"close\" aria-label=\"Close\" (click)=\"activeModal.dismiss('Cross click')\">\n    <span aria-hidden=\"true\">&times;</span>\n  </button>\n</div>\n<div class=\"modal-body\">\n  <form [formGroup]=\"todoForm\" (ngSubmit)=\"saveTodo()\">\n    <div class=\"form-group\">\n      <label for=\"title\">Nombre Apellidos y número de placa</label>\n      <input type=\"text\" id=\"title\" placeholder=\"Escribir datos personales y placa\" class=\"form-control\" formControlName=\"title\" />\n      <span style=\"color:Red;\" *ngIf=\"todoForm.controls['title'].touched && todoForm.controls['title'].errors?.required\">Por favor escribir datos personales y placa</span>\n    </div>\n    <div class=\"form-group\">\n      <label for=\"description\">Por Favor necesitamos tú narración de los hechos</label>\n      <textarea  id=\"description\" placeholder=\"Escribir aquí todos los detalles del evento\" class=\"form-control\" formControlName=\"description\"></textarea>\n      <span style=\"color:Red;\" *ngIf=\"todoForm.controls['description'].touched && todoForm.controls['description'].errors?.required\">Escribe que fue lo que pasó</span>\n    </div>\n    <div class=\"form-check\">\n      <input class=\"form-check-input\" type=\"checkbox\" value=\"\" id=\"done\" formControlName=\"done\">\n      <label class=\"form-check-label\" for=\"done\">\n        He creado mi declaración Jurada\n      </label>\n    </div>\n  </form>\n</div>\n<div class=\"modal-footer\">\n  <button type=\"button\" class=\"btn btn-outline-dark\" (click)=\"activeModal.close('Close click')\">Cerrar</button>\n  <button class=\"btn btn-primary\" (click)=\"saveTodo()\" [disabled]=\"todoForm.invalid\">Salvar</button>\n</div>\n");
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            "use strict";
            __webpack_require__.r(__webpack_exports__);
            /* harmony default export */ __webpack_exports__["default"] = ("<h4>Hola necesitamos tú declaración del accidente :</h4>\n\n<button class=\"btn btn-primary\" (click)=\"clickAddTodo()\">Empezar </button>\n\n<table class=\"table table-striped\" *ngIf=\"todos && todos.length > 0\">\n    <thead>\n        <tr>\n            <th>Hecho</th>\n            <th>Titulo</th>\n            <th>Crear fecha</th>\n        </tr>\n    </thead>\n    <tbody>\n        <tr *ngFor=\"let todo of todos, let index = index\">\n            <td><input type=\"checkbox\" [checked]=\"todo.done\" (change)=\"checkedDone(index)\" /></td>\n            <td [ngClass]=\"{'done': todo.done, 'not-done': !todo.done}\">{{todo.title}}</td>\n            <td>{{todo.lastModifiedDate | date}}</td>\n            <td>\n                <button class=\"btn btn-primary\" (click)=\"handleEditClick(todo)\">Editar</button>\n                <button class=\"btn btn-danger\" (click)=\"handleDeleteClick(todo.id, index)\">Borrar</button>\n            </td>\n        </tr>\n    </tbody>\n</table>\n");
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _todo_todo_list_todo_list_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./todo/todo-list/todo-list.component */ "./src/app/todo/todo-list/todo-list.component.ts");
            /* harmony import */ var _contact_contact_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./contact/contact.component */ "./src/app/contact/contact.component.ts");
            var routes = [
                { path: '', component: _todo_todo_list_todo_list_component__WEBPACK_IMPORTED_MODULE_3__["TodoListComponent"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
                Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
                    ...
                    entryComponents: [_todo_todo_form_todo_form_component__WEBPACK_IMPORTED_MODULE_11__["TodoFormComponent"]]
                })
            ], AppModule);
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TodoService = /** @class */ (function () {
                function TodoService(db) {
                    this.db = db;
                    this.todoCollectionName = 'todos';
                }
                TodoService.prototype.getTodos = function () {
                    return this.db.collection(this.todoCollectionName, function (ref) { return ref.orderBy('lastModifiedDate', 'desc'); }).get();
                };
                ...
                TodoService.prototype.editTodoPartial = function (id, obj) {
                    return this.db.collection(this.todoCollectionName).doc(id).update(obj);
                };
                TodoService.prototype.deleteTodo = function (idTodo) {
        ...
        /***/ "./src/app/todo/todo-form/todo-form.component.css": 
        /*!********************************************************!*\
          !*** ./src/app/todo/todo-form/todo-form.component.css ***!
          \********************************************************/
        /*! exports provided: default */
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            "use strict";
            __webpack_require__.r(__webpack_exports__);
            /* harmony default export */ __webpack_exports__["default"] = ("\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3RvZG8vdG9kby1mb3JtL3RvZG8tZm9ybS5jb21wb25lbnQuY3NzIn0= */");
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _services_todo_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../services/todo.service */ "./src/app/todo/services/todo.service.ts");
            var TodoFormComponent = /** @class */ (function () {
                function TodoFormComponent(formBuilder, activeModal, todoService) {
                ...
                TodoFormComponent.prototype.loadTodo = function (todo) {
                    this.todoForm.patchValue(todo);
                };
                TodoFormComponent.prototype.saveTodo = function () {
                    var _this = this;
                    if (this.todoForm.invalid) {
                        return;
                    }
                    if (this.createMode) {
                        var todo_1 = this.todoForm.value;
                        todo_1.lastModifiedDate = new Date();
                        todo_1.createdDate = new Date();
                        this.todoService.saveTodo(todo_1)
                            .then(function (response) { return _this.handleSuccessfulSaveTodo(response, todo_1); })
                            .catch(function (err) { return console.error(err); });
                    }
                    else {
                        var todo_2 = this.todoForm.value;
                        todo_2.id = this.todo.id;
                        todo_2.lastModifiedDate = new Date();
                        this.todoService.editTodo(todo_2)
                            .then(function () { return _this.handleSuccessfulEditTodo(todo_2); })
                            .catch(function (err) { return console.error(err); });
                    }
                };
                TodoFormComponent.prototype.handleSuccessfulSaveTodo = function (response, todo) {
                    this.activeModal.dismiss({ todo: todo, id: response.id, createMode: true });
                };
                TodoFormComponent.prototype.handleSuccessfulEditTodo = function (todo) {
            ...
            TodoFormComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
                Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
                    ...
                    styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./todo-form.component.css */ "./src/app/todo/todo-form/todo-form.component.css")).default]
                })
            ], TodoFormComponent);
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            "use strict";
            __webpack_require__.r(__webpack_exports__);
            /* harmony default export */ __webpack_exports__["default"] = (".done{\n    text-decoration: line-through;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */");
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _todo_form_todo_form_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../todo-form/todo-form.component */ "./src/app/todo/todo-form/todo-form.component.ts");
            /* harmony import */ var _services_todo_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../services/todo.service */ "./src/app/todo/services/todo.service.ts");
            var TodoListComponent = /** @class */ (function () {
                function TodoListComponent(modalService, todoService) {
                ...
                TodoListComponent.prototype.loadTodos = function () {
                    var _this = this;
                    this.todoService.getTodos().subscribe(function (response) {
                        _this.todos = [];
                        response.docs.forEach(function (value) {
                            var data = value.data();
                            var id = value.id;
                            var todo = {
                                id: id,
                ...
                TodoListComponent.prototype.clickAddTodo = function () {
                    var modal = this.modalService.open(_todo_form_todo_form_component__WEBPACK_IMPORTED_MODULE_3__["TodoFormComponent"]);
                    modal.result.then(this.handleModalTodoFormClose.bind(this), this.handleModalTodoFormClose.bind(this));
                };
                TodoListComponent.prototype.handleModalTodoFormClose = function (response) {
                    ...
                    if (response === Object(response)) {
                        if (response.createMode) {
                            ...
                            var index = this.todos.findIndex(function (value) { return value.id == response.id; });
                            this.todos[index] = response.todo;
                        }
                    }
                };
                TodoListComponent.prototype.checkedDone = function (index) {
                    var newDoneValue = !this.todos[index].done;
                    this.todos[index].done = newDoneValue;
                    var obj = { done: newDoneValue };
                    var id = this.todos[index].id;
                    this.todoService.editTodoPartial(id, obj);
                };
                TodoListComponent.prototype.handleEditClick = function (todo) {
                    var modal = this.modalService.open(_todo_form_todo_form_component__WEBPACK_IMPORTED_MODULE_3__["TodoFormComponent"]);
                    modal.result.then(this.handleModalTodoFormClose.bind(this), this.handleModalTodoFormClose.bind(this));
                    modal.componentInstance.createMode = false;
                    modal.componentInstance.todo = todo;
                };
                TodoListComponent.prototype.handleDeleteClick = function (todoId, index) {
                    var _this = this;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var environment = {
                production: false,
                firebase: {
                    apiKey: "AIzaSyBCS0hFOh0M15NklV7dZJk_c5cpaS8f-EA",
                    authDomain: "carbuncs-angular.firebaseapp.com",
                    databaseURL: "https://carbuncs-angular.firebaseio.com",
                    projectId: "carbuncs-angular",
                    storageBucket: "carbuncs-angular.appspot.com",
                    messagingSenderId: "22651544106",
                    appId: "1:22651544106:web:ff584adf942abb2fb95953",
                    measurementId: "G-K7JLSHHQSM"
                }
            };
            /*
        ...
        /***/ (function (module, exports, __webpack_require__) {
            module.exports = __webpack_require__(/*! C:\Users\Usuario.DESKTOP-P2OGJG5\Desktop\angular\angular-todo\src\main.ts */ "./src/main.ts");
            /***/ 
        })
    }, [[0, "runtime", "vendor"]]]);
